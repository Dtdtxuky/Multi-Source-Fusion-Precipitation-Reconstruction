    ...
    def __getitem__(self, idx):
        ...
        for attempt in range(max_attempts):
            ...
            if sat_data is not None:
                ...
                return {'latent':lat_data, 'inputs':inp_sat_data, 'original':oup_data ,'file_name':file}
            else:
...
if __name__ == "__main__":
    dataset1 = CMA_Dataset(file_path='/mnt/petrelfs/xukaiyi/CodeSpace/SplitDataSet/Path/TrainPath/Train_path_3years_pre_th1_5_th2_500_radar_th1_3_th2_400.txt', phase='train')
    dataset2 = CMA_Dataset(file_path='/mnt/petrelfs/xukaiyi/CodeSpace/SplitDataSet/Path/TestPath/TestSetting3.txt', phase='train')
    loader1 = torch.utils.data.DataLoader(dataset1, batch_size=32, num_workers=16)
    loader2 = torch.utils.data.DataLoader(dataset2, batch_size=32, num_workers=16)
    
    print("Len:" ,len(loader1))
    idx = 1
