...
if __name__ == "__main__":
    ...
    parser.add_argument('--outdir',                     type = str,     default='/mnt/petrelfs/xukaiyi/CodeSpace/DiT/Experiment',  help = 'Where to save the results')
    parser.add_argument('--cfg', '-c',                  type = str,     default = '/mnt/petrelfs/xukaiyi/CodeSpace/DiT/configs/sevir_used/compress_gt.yaml',      help = 'path to the configuration file')
    ...
    parser.add_argument('--mydataset', type=str, default='AE', help='resume from cfg file')
