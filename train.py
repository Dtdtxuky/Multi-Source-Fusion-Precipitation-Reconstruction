...
if __name__ == "__main__":
    ...
    parser.add_argument('--outdir',                     type = str,     default='/mnt/petrelfs/xukaiyi/CodeSpace/CasCast_new/Experiment',  help = 'Where to save the results')
    parser.add_argument('--cfg', '-c',                  type = str,     default = '/mnt/petrelfs/xukaiyi/CodeSpace/CasCast_new/configs/sevir_used/autoencoder_kl_gan.yaml',      help = 'path to the configuration file')
    ...
    parser.add_argument('--mydataset', type='AE', default=None, help='resume from cfg file')
